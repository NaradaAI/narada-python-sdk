...
def test_parse_action_trace_accepts_historical_numeric_sub_agent_type() -> None:
    ...
    assert trace[0].events[0].agent_type == "operator"


def test_parse_action_trace_accepts_historical_numeric_nested_sub_agent_type() -> None:
    trace = parse_action_trace(
        [
            {
                "step_type": "pythonAgentRun",
    ...
    assert nested_trace[0].events[0].agent_type == "operator"
