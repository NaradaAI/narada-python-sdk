...
| [`03_connect_a_vector_store.py`](04_extending_the_agent/03_connect_a_vector_store.py) | Resolve a managed vector store by its canonical owner-qualified path and attach it to an agent run. |
